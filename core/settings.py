...
DATABASES = {
    "default": {
        ...
        "PORT": os.environ.get("DB_PORT",5423),
    }
}
...
CORS_ALLOWED_ORIGINS = ["http://localhost:3000", "http://127.0.0.1:3000", "https://main--jobapplication-reviewer.netlify.app","https://jobapplication-reviewer.netlify.app"]
